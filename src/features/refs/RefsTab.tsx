...
// ---------------------------------------------------------------------------
// Static reference data (sourced from the original monolithic index.html)
// ---------------------------------------------------------------------------
...
const REFERENCES: Reference[] = [
  ...
  { id: 4, text: 'Sambrook, J. & Russell, D. W. (2001). Molecular Cloning: A Laboratory Manual, 3rd edition.', journal: 'Cold Spring Harbor Laboratory Press', note: '分子克隆实验手册（经典参考书），含各类 buffer 配方' },
  { id: 5, text: 'Green, M. R. & Sambrook, J. (2012). Molecular Cloning: A Laboratory Manual, 4th edition.', journal: 'Cold Spring Harbor Laboratory Press', note: '分子克隆第四版，更新版参考手册' },
  ...
  { id: 10, text: 'Bio-Rad Laboratories. Mini-PROTEAN® Tetra Handcast Systems Instruction Manual.', journal: 'Bio-Rad Tech Note', note: '胶配方和操作规范参考 (工业标准)' },
...
const REF_NOTES_EN: Record<number, string> = {
  ...
  return (
    <div className="fade-in">
      ...
      <div className="space-y-3">
        {REFERENCES.map((ref) => (
          <div key={ref.id} className="card p-4 flex gap-4">
            {/* Numbered badge */}
            <div
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs mt-1">
                ...
                {ref.vol && (
                  <span className="text-gray-500"> {ref.vol}</span>
                )}
                {ref.pages && (
              ...
              {/* Contextual note (EN or ZH) */}
              <p
                className="text-xs mt-1.5 rounded px-2 py-1 inline-block"
      ...
      >
        <h3 className="text-sm font-bold mb-2">{t('refs.usageGuide')}</h3>
