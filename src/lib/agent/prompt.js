...
const RED_LINES = [
  ...
  'All numbers — dilutions, masses, molarity, ΔΔCt, statistics — go through runCalculator/analyzeData. Never compute them yourself; never state a computed number the tools did not return.',
